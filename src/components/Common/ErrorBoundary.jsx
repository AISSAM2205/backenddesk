    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          {/* Icon */}
          <div style={{
            width: 54, height: 54, borderRadius: 14, margin: '0 auto 22px',
          ...
          <h2 style={{
            fontFamily: 'var(--f-disp)', fontWeight: 800, fontSize: '0.88rem',
            letterSpacing: '0.12em', textTransform: 'uppercase',
            color: 'var(--tx1)', marginBottom: 10,
          }}>
            Erreur de rendu
          </h2>

          <p style={{
            fontFamily: 'var(--f-body)', fontSize: '0.82rem',
            color: 'var(--tx2)', marginBottom: 24, lineHeight: 1.65,
          }}>
            Un problème inattendu est survenu dans cette section.
            Cliquez sur <strong style={{ color: 'var(--tx1)' }}>Réessayer</strong> ou rafraîchissez la page.
          </p>
          ...
          {err && (
            <div style={{
              ...
              borderRadius: 8, padding: '12px 14px', marginBottom: 26,
              textAlign: 'left', overflowX: 'auto',
            }}>
              <p style={{
                fontFamily: 'var(--f-mono)', fontSize: '0.70rem', fontWeight: 600,
                color: 'var(--loss)', marginBottom: err.stack ? 8 : 0,
              }}>
              ...
              {err.stack && (
                <pre style={{
                  ...
                  color: 'var(--tx3)', whiteSpace: 'pre-wrap',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 10 }}>
            <button
              ...
              style={{
                ...
                background: 'var(--surf)', border: '1px solid var(--b2)',
                fontFamily: 'var(--f-disp)', fontWeight: 700, fontSize: '0.65rem',
