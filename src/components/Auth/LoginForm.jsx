    ...
    >
      ...
      <div
        ...
        style={{
          ...
          boxShadow:
            "0 32px 80px rgba(0,0,0,0.65), 0 4px 24px rgba(14,165,233,0.08)",
        }}
      >
        {/* ── Header: logo + clock ── */}
        <div
        ...
        {error && (
          ...
          >
            <AlertCircle
              size={13}
              style={{ color: T.err, flexShrink: 0, marginTop: 1 }}
            />
            <span
              style={{
                fontFamily: "var(--f-body)",
        ...
        <div style={{ marginTop: 24 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={loginAsTrader} className="__lf-ghost">
              Trader
            </button>
            <button onClick={loginAsAdmin} className="__lf-ghost">
              Admin
            </button>
          </div>
        </div>
      ...
      >
        ...
        <span
          style={{ width: 1, height: 10, background: "rgba(255,255,255,0.15)" }}
        />
        <span
          style={{
            fontFamily: "var(--f-mono)",
